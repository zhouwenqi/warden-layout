export default {
  ...
  'config.setting.theme.color.title': 'Solid color',  
  ...
  'config.setting.menuBackgroundStyle.title':'Main menu background style',
  ...
  'config.option.menuBackgroundStyle.normal':'Purity',
  'config.option.menuBackgroundStyle.black':'Black',
  'config.option.menuBackgroundStyle.primary':'Primary',
